              ...
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                ...
                <div className="lg:col-span-7 space-y-6 animate-reveal">
                  <span className="mino-eyebrow">
                    ...
                    Liquid Funds App for India
                  </span>
                  <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl text-mino-ink leading-[1.2] tracking-tight">
                    Earn up to 7% annual returns on your idle money.<br />
                    <em className="not-italic text-mino-forest font-semibold">
                      Invest online. Withdraw instantly.
                    </em>
                  </h1>
                  <p className="text-lg md:text-xl text-mino-ink/70 max-w-xl leading-relaxed">
                    A smarter alternative to your regular savings account. Park your idle cash in SEBI-regulated liquid mutual funds for better returns and complete cash management. Zero lock-in, no hidden charges.
                  </p>
            ...
            <div className="container mx-auto px-6 space-y-32">
              ...
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-6 space-y-6 lg:order-2">
                  <span className="mino-eyebrow">Smart Savings Goals</span>
                  <h2 className="font-serif text-4xl md:text-5xl text-mino-ink leading-tight tracking-tight">
                    Create pockets for every savings goal, all in one place.
                  </h2>
                  <p className="text-base text-mino-ink/70 leading-relaxed">
                    Turn your milestones into achievements, faster. Pockets are flexible containers that let you seamlessly divide and organize your wealth for short-term savings and long-term wealth building, without the hassle of managing multiple bank accounts. Perfect for your emergency fund or daily savings.
                  </p>
                </div>
              ...
              <div className="grid lg:grid-cols-12 gap-12 items-center">
                <div className="lg:col-span-6 space-y-6">
                  <span className="mino-eyebrow">Instant Withdrawals</span>
                  <h2 className="font-serif text-4xl md:text-5xl text-mino-ink leading-tight tracking-tight">
                    Withdraw your money instantly, no waiting.
                  </h2>
                  <p className="text-base text-mino-ink/70 leading-relaxed">
                    Real-time cash management with liquidity routed directly to your linked primary bank account. Whether it is a weekend, a public holiday, or a late-night emergency; your money remains accessible within minutes. Zero lock-in, no exceptions.
                  </p>
                </div>
          ...
          <section id="partners" className="bg-mino-cream py-20 border-t border-mino-line text-center">
            <div className="container mx-auto px-6 max-w-4xl space-y-8">
              <div className="space-y-3">
                <span className="mino-eyebrow justify-center">Financial Planning Infrastructure</span>
                <h2 className="font-serif text-3xl md:text-4xl text-mino-ink">Built on trusted, regulated infrastructure.</h2>
                <p className="text-mino-ink/70 text-sm md:text-base max-w-2xl mx-auto leading-relaxed">
                  Your personal finance and investment capital is handled securely by India&apos;s leading financial institutions, routed entirely via SEBI-regulated Mutual Funds. Grow money with peace of mind.
                </p>
              </div>
